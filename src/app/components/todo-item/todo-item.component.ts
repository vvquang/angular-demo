...
import { faMinus, faPlus, faTrashCan, faPenToSquare, faCheck, faXmark } from '@fortawesome/free-solid-svg-icons';
...
export class TodoItemComponent implements OnInit {
  ...
  @Output() onEdit = new EventEmitter<{ id: string; quantity: number }>();
